...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, sdf.parse("27/03/2020"), "Partiu Viajem", "Vou viajar para São Paulo. Abraços", maria);
		Post p2 = new Post(null, sdf.parse("26/03/2020"), "Bom dia", "Acordei feliz hoje", maria);
